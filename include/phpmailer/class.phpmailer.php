...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'support@ukm.no';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'UKM Norge';
   ...
   * @var string
   */
  public $Host          = 'mail.support.ukm.no';
   ...
   * @var string
   */
  public $Username      = 'post@support.ukm.no';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'supportukm2009';
